...
\NormalTok{harlan.raw}\OperatorTok{$}\NormalTok{labor.hours <-}\StringTok{ }\KeywordTok{as.integer}\NormalTok{(harlan.raw}\OperatorTok{$}\NormalTok{labor.hours)}
...
\NormalTok{dickenson.raw}\OperatorTok{$}\NormalTok{labor.hours <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(dickenson.raw}\OperatorTok{$}\NormalTok{labor.hours)}
\end{Highlighting}
\end{Shaded}
